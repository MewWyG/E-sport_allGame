...
const instructions = [
  'ตัวละครจะปรากฏขึ้นแบบสุ่ม โดยเป็นศัตรู 👹 หรือพวกพ้อง 🤝',
  'หากเป็นศัตรู ให้กดปุ่ม SHOOT หรือ Space เพื่อยิงให้เร็วที่สุด',
  'หากเป็นพวกพ้อง ห้ามยิง ปล่อยให้เวลาผ่านไป',
  'ยิงผิด, ปล่อยให้ศัตรูหนีรอด หรือยิงพวกพ้อง = เสียหัวใจ',
  'เมื่อหัวใจหมด เกมจะจบและสรุปผลคะแนน + Reaction Time',
]

const difficultyRules = [
  { score: 'Score 0-4', detail: 'ความเร็ว 1250 ms', extra: 'เริ่มต้น' },
  { score: 'Score 5-9', detail: 'ความเร็ว 1125 ms', extra: 'เร็วขึ้น' },
  { score: 'Score 10-19', detail: 'ความเร็ว 1000 ms', extra: 'Medium' },
  { score: 'Score 20-29', detail: 'ความเร็ว 850 ms', extra: 'Hard' },
  { score: 'Score 30-39', detail: 'ความเร็ว 720 ms', extra: 'Very Hard' },
  { score: 'Score 40+', detail: 'ความเร็ว 600 ms', extra: 'Extreme' },
]

export function QuickDecisionInfoPage() {
      ...
      <main className="mx-auto w-full max-w-sp-page flex-grow px-6 py-12 md:px-12 md:py-20">
        <section className="animate-sp-fade-in mx-auto max-w-4xl">
          ...
          <div className="rounded-sp-card border border-sp-border bg-sp-glass p-8 backdrop-blur-xl md:p-12">
            <div className="flex flex-col items-center gap-10 md:flex-row md:gap-12">
              ...
              <div className="flex-grow text-center md:text-left">
                ...
                <p className="mb-8 text-xl leading-relaxed text-sp-text-muted">
                  ทดสอบการตัดสินใจอย่างรวดเร็ว แยกแยะศัตรูและพวกพ้อง
                  ภายในเสี้ยววินาที พร้อมวัดความเร็วในการตอบสนอง
                </p>

                <AppButton
                  onClick={() => navigate('/gameplay/quickdecision')}
            ...
            <div className="mt-12">
              <h2 className="mb-6 text-xl font-bold text-sp-text">ระดับความยากตาม Score</h2>
            ...
            <div className="mt-12 grid grid-cols-1 gap-4 md:grid-cols-3">
              <InfoBox label="รูปแบบเกม" value="Reaction & Decision" />
